    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            .csrf()
                ...
                .antMatchers(HttpMethod.GET, "/allParentsBookings").hasRole("MANAGER")
                ...
                .antMatchers(HttpMethod.GET, "/adm-edit-location").hasRole("ADMINISTRATOR")
                .antMatchers(HttpMethod.POST, "/adm-edit-location").hasRole("ADMINISTRATOR")
                .antMatchers(HttpMethod.GET, "/adm-add-location").hasRole("ADMINISTRATOR")
                .antMatchers(HttpMethod.POST, "/adm-add-location").hasRole("ADMINISTRATOR")
                .and()
