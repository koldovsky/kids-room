...
messages = {
	...
	notCorrect: {
		...
		date: 'Введено неправильну дату. Допустимий формат: <b>dd:MM:YYYY</b>',
		server: '<b>невідомо</b>. Помилка сервера',
		emptyStartDate: "Не введено початкову дату",
		emptyEndDate: "Не введено кінцеву дату",
		startDay: "Початкова дата на може бути в минулому",
		endDay: "Кінцева дата не може бути меншою за початкову",
		wrongDatesRange: 'Виюраний період має бути в межах '
