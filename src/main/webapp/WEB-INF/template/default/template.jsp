...
<c:choose>
  <c:when test="${pageContext.response.locale =='ua'}">
    <script src="${pageContext.request.contextPath}/resources/js/lib/messages-ua.js"></script>
  </c:when>
  <c:when test="${pageContext.response.locale == 'en'}">
    <script src="${pageContext.request.contextPath}/resources/js/lib/messages.js"></script>
  </c:when>
</c:choose>
