    ...
    <form:form class = "adm-edit-manager" modelAttribute="manager" action="adm-update-manager" method="post">
        ...
        <div class="form-group">
           <label for="lastName" class="for-field">Last Name
              <form:input path="lastName" id="lastName" value="${manager.lastName}" class="form-control" required="required"/>
           </label>
        </div>

        <div class="form-group">
           <label for="phoneNumber" class="for-field">Phone number
              <form:input path="phoneNumber" id="phoneNumber" value="${manager.phoneNumber}" pattern="^(\+38|8|)(\W*\d){10}\W*$"
