...
<div class="col-sm-offset-4 col-sm-3" id="reg-form">
    <form:form id="userform" action="registration" method="post"  modelAttribute="user">
        ...
        <div class="form-group">
              <spring:message code="user.prerules"/> <a data-toggle="modal" data-target="#rules"> <spring:message code="user.ruless" /></a>
              <div id="reg-button">
...
<c:if test="${pageContext.response.locale=='ua'}">
    ...
    <script src="${pageContext.request.contextPath}/resources/js/validation/validation-registration-ua.js"></script>
</c:if>
<script src="${pageContext.request.contextPath}/resources/js/validation/validation-registration.js"></script>
